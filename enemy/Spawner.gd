...
var preloadedTrash := [
	preload("res://enemy/RedTrash.tscn"),
	preload("res://enemy/BlueTrash.tscn"),
	preload("res://enemy/GreenTrash.tscn"),
	preload("res://enemy/YellowTrash.tscn"),
	preload("res://enemy/BlackTrash.tscn")
	]
